...
//if(match[1] == '') return 
    if (type === 'image') { await message.sendMessage(data, MessageType.image,{ caption: "*ᴍᴀᴅᴇ ʙʏ DXTROX Вⷡoͦᴛⷮ*" }) }
    else if (type === 'video') { await message.sendMessage(data, MessageType.video,{ caption: "*ᴍᴀᴅᴇ ʙʏ DXTROX Вⷡoͦᴛⷮ*" }) }
});
//const axios = require('axios')
